"""
Django settings for cobblestone project.
...
SECRET_KEY = 'django-insecure-%)xn(#-_d##so%#hw_q*grh69ko291@tulg=+$957p!c0ez4_^'
...
WSGI_APPLICATION = 'cobblestone.wsgi.application'
